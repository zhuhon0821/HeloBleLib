...
struct InfoTime {
  ...
  enum OneOf_Data: Equatable {
    ...
    static func ==(lhs: InfoTime.OneOf_Data, rhs: InfoTime.OneOf_Data) -> Bool {
      ...
      case (.timePointer, .timePointer): return {
        guard case .timePointer(let l) = lhs, case .timePointer(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      default: return false
      }
...
extension InfoTimePointer: @unchecked Sendable {}
