...
struct HisData {
  ...
  enum OneOf_Data: Equatable {
    ...
    static func ==(lhs: HisData.OneOf_Data, rhs: HisData.OneOf_Data) -> Bool {
      ...
      case (.thirdPartyData, .thirdPartyData): return {
        guard case .thirdPartyData(let l) = lhs, case .thirdPartyData(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.thirdPartyDataV2, .thirdPartyDataV2): return {
        guard case .thirdPartyDataV2(let l) = lhs, case .thirdPartyDataV2(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      default: return false
      }
