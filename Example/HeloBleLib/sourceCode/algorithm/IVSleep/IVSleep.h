...
typedef enum
{
    ...
    IV_SA_STATE_SLEEP_EYE_MOVE//快速眼动
}iv_sa_sleepState;
...
- (IV_SA_SleepBufInfo)ivSleepDataFrom:(NSString *)yesterdayPath andTodayPath:(NSString *)todayPath andDate:(NSString *)date andRriData:(NSArray <NSNumber *>*)rris andError:(NSError **)error;
